    ...
    <v-row no-gutters>
      <svg viewBox="0 0 845 185" class="svg_footer">
        ...
        <path
          ...
          fill="url(#paint0_linearfooter)"
        />
        <defs>
          <linearGradient
            id="paint0_linearfooter"
            x1="8.94307e-09"
            y1="185"
            x2="845"
            y2="185"
          ...
          >
            <stop stop-color="#51B5F7" />
            <stop offset="1" stop-color="#5291FB" />
          </linearGradient>
        </defs>
      </svg>
    </v-row>
...
.card_footer {
  background: linear-gradient(90deg, #51b5f7 -0.06%, #5291fb 100%);
}
